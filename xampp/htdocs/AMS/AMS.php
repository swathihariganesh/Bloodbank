...
<html>
    ...
    <body>
        ...
        <div id='DR' style='display:none'>
            ...
            <div class='myBtn' onclick='calculate_detailed_report(getElementById("startDate_DR").value, getElementById("endDate_DR").value)' style='display:inline-block'>Calculate</div>
            <table id='DR_TABLE'>
                <thead>
